    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center relative py-12 px-4">
      ...
      <main className="z-10 flex flex-col items-center justify-center text-center w-full max-w-4xl mx-auto space-y-10 md:space-y-16">
        <div className="space-y-6">
          ...
          <h1 className="text-4xl md:text-7xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-br from-white via-stone-200 to-stone-500 pb-2 px-2">
        ...
        <div className="flex flex-col w-full sm:flex-row items-center justify-center gap-4 pt-4 px-4">
          <Button 
            size="lg" 
            className="bg-white text-stone-950 hover:bg-stone-200 transition-all duration-300 font-semibold px-8 h-14 rounded-xl text-lg flex items-center justify-center gap-3 shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_-15px_rgba(255,255,255,0.5)] w-full sm:w-auto"
